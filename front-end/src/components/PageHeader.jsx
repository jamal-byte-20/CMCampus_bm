...
// نمرر الـ title كـ prop لكي يتغير من صفحة لأخرى
const PageHeader = ({ title }) => {
  return (
    <section className="relative w-full mt-16 sm:mt-20 h-[180px] sm:h-[220px] md:h-[250px] flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="text-center z-10 px-4">
        ...
        <div className="flex items-center justify-center gap-2 sm:gap-3 text-sm md:text-base font-medium">
          ...
          {/* الخط الوردي الصغير الموجود في الصورة */}
